...
class UlasanProfil(models.Model):
    ...
    diulas = models.ForeignKey(RegisteredUser, on_delete=models.CASCADE, blank=False, null=True, related_name='%(class)s_diulas') # Blank = False so form field should never be null, but db may contain null
